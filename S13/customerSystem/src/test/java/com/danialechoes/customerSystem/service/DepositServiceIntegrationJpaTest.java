...
public class DepositServiceIntegrationJpaTest {
    ...
    void setUp() {
        ...
        depositService.addDeposit(customer.getId(), Currency.EUR);
    ...
    void testTransferAmount() {
        RealCustomer targetCustomer = new RealCustomer();
        targetCustomer.setName("Jane");
        targetCustomer.setFamily("Doe");
        targetCustomer.setPhoneNumber("0987654321");
        customerService.addCustomer(targetCustomer);
        Long targetCustomerId = targetCustomer.getId();
