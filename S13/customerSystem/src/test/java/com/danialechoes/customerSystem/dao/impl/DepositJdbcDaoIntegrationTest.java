...
public class DepositJdbcDaoIntegrationTest {
    ...
    private Deposit createDeposit(double amount, LegalCustomer customer,
                                  Currency currency) {
    ...
    private Deposit createDeposit(double amount, LegalCustomer customer) {
        return createDeposit(amount, customer, Currency.EUR);
    }
    ...
    void saveAndFindById() {
        ...
        Deposit deposit = createDeposit(1000.0,customer);
    ...
    void deleteById(){
        ...
        Deposit deposit = createDeposit(500.0, customer);
        deposit.setCustomer(customer);
        deposit = depositJdbcDao.save(deposit);
    ...
    void findByCustomerId() {
        ...
        Deposit deposit = createDeposit(2000.0, customer);
        deposit = depositJdbcDao.save(deposit);
    ...
    void findAll() {
        ...
        Deposit deposit1 = createDeposit(3000.0, customer1);
        depositJdbcDao.save(deposit1);

        Deposit deposit2 = createDeposit(4000.0, customer2);
    ...
    void updateDeposit() {
        ...
        Deposit deposit = createDeposit(1500.0, customer);
        deposit = depositJdbcDao.save(deposit);
    ...
    void checkVersionUpdatedAfterFindById() {
        ...
        Deposit deposit = createDeposit(3500.0, customer);
        deposit = depositJdbcDao.save(deposit);
